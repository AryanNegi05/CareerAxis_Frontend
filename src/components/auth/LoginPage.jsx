...
import { login } from '../../store/api/authApi'; // Adjust this path based on your project structure
import { Mail, Lock, Eye, EyeOff, User } from 'lucide-react'; // Or another icon library
