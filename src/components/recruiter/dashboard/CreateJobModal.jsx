                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">Create a new job posting to find great candidates</p>
                    </div>
                  </div>
                  <button
                    onClick={onClose}
              ...
              <div className="bg-gradient-to-r from-gray-50 to-slate-50 px-8 py-6 border-t border-gray-100">
                <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
                  <div className="flex items-center space-x-2 text-sm text-gray-600">
                    ...
                    <span>Your job will be visible to thousands of candidates</span>
                  </div>
